...
open(types_path, "w") do io
    ...
    write(io, "This page documents all types defined in TimeSamplers.jl, generated using [`get_type_docstring`](https://landecosystems.github.io/OmniTools.jl/dev/api/ForDocStrings.html#OmniTools.ForDocStrings.get_type_docstring) from OmniTools.jl.\n\n")
    write(io, "```@meta\n")
